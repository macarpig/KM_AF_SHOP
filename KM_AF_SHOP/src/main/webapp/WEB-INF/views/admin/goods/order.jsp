	...
	<div id="content">
		...
		<div class="container-fluid">
			...
			<div
				...
				<h1 class="h3 mb-0 text-gray-800">주문 목록</h1>
			</div>
						...
						<div class="card-body">
							...
							<c:forEach items="${list}" var="list">
								<div class="row">
									...
									<div class="col">${list.userId}</div>
									<div class="col">${list.orderRecvr}</div>
									<div class="col">${list.orderZipCode}</div>
									<div class="col">${list.orderAddr1} ${list.orderAddr2}</div>
									<div class="col">${list.orderTel1} - ${list.orderTel2} - ${list.orderTel3}</div>
									<div class="col">
